...
('cardinity-oxid-module', 1, 'Credit Card', 0, 'abs', 15, 0, 0, 99999, 'ccnumber__@@ccname__@@ccyear__@@ccmonth__@@ccpruef__@@', 0, '', '', '', '', '', '', '', '', '', '', 0, '', '2015-02-26 07:34:14');
...
ALTER TABLE  `oxorder` ADD `cardinity_refunded` DATETIME NOT NULL
